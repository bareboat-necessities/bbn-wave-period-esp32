...
static kalman_measurement_t* KALMAN_MEASUREMENT_FUNCTION_NAME(init)() {
  ...
  kalman_measurement_initialize(&KALMAN_MEASUREMENT_BASENAME, KALMAN_NUM_STATES, KALMAN_NUM_MEASUREMENTS,
                                ...
                                __KALMAN_BUFFER_maux, __KALMAN_BUFFER_Sinv, __KALMAN_BUFFER_tempHP,
                                __KALMAN_BUFFER_tempPHt, __KALMAN_BUFFER_tempKHP);
...
// TODO: instead of cleaning up the temporary buffers here, clean them up in KalmanFactoryCleanup.h.
// This way, the largest buffers can be reused in other measurement definitions.
