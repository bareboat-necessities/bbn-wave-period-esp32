...
void kalman_wave_init_defaults() {
  ...
  matrix_data_t variance = (matrix_data_t) 2.0;
  ...
  matrix_set_symmetric(Q, 1, 1, (matrix_data_t)0.05 * variance);
  matrix_set_symmetric(Q, 1, 2, (matrix_data_t)0.0);
  matrix_set_symmetric(Q, 1, 3, (matrix_data_t)0.0);
  matrix_set_symmetric(Q, 2, 2, (matrix_data_t)0.0025 * variance);
  matrix_set_symmetric(Q, 2, 3, (matrix_data_t)0.0);
  matrix_set_symmetric(Q, 3, 3, (matrix_data_t)0.000125 * variance);
}
