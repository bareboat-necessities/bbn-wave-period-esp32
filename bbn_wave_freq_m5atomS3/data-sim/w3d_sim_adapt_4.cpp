...
const float FAIL_ERR_LIMIT_PERCENT_Z_PMSTOKES  = 14.0f;

const float FAIL_ERR_LIMIT_YAW_DEG = 4.0f;  

const float FAIL_ERR_LIMIT_PERCENT_3D_JONSWAP   = 38.0f;
const float FAIL_ERR_LIMIT_PERCENT_3D_PMSTOKES  = 38.0f;
