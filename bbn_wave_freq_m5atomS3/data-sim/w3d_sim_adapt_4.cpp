...
const float FAIL_ERR_LIMIT_PERCENT_Z_JONSWAP   = 18.0f;
const float FAIL_ERR_LIMIT_PERCENT_Z_PMSTOKES  = 18.0f;

const float FAIL_ERR_LIMIT_YAW_DEG = 8.0f;  

const float FAIL_ERR_LIMIT_PERCENT_3D_JONSWAP   = 75.0f;
const float FAIL_ERR_LIMIT_PERCENT_3D_PMSTOKES  = 75.0f;

const float FAIL_ACC_Z_BIAS_PERCENT             = 80.0f;
