...
const float FAIL_ERR_LIMIT_PERCENT_HIGH = 15.0f;
const float FAIL_ERR_LIMIT_PERCENT_LOW = 15.0f;
...
inline std::map<WaveType, std::vector<TuningIMU>> make_tuning_map() {
    return {
        { WaveType::JONSWAP, {
            { 0.93367, 0.50540, R_S_law(3.0)  },
            { 1.17722, 1.05237, R_S_law(5.7)  },
            { 1.43084, 1.52669, R_S_law(8.5)  },
            { 1.52335, 2.01986, R_S_law(11.4) }
        }},
        { WaveType::PMSTOKES, {
            { 0.92128, 0.58012, R_S_law(3.0)  },
            { 1.14520, 1.19688, R_S_law(5.7)  },
            { 1.27596, 1.62909, R_S_law(8.5)  },
            { 1.39946, 2.07945, R_S_law(11.4) }
        }}
    };
}
