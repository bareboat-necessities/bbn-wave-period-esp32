...
const float FAIL_ERR_LIMIT_PERCENT = 18.0f; 
...
const std::map<WaveType, std::vector<TuningIMU>> tuning_map = {
    ...
    { WaveType::PMSTOKES, {
        ...
        { 0.47746, 0.52831,   0.0203391 / kf },   // Tp=3.0,  Hs=0.27
        { 0.90718, 0.93033,   0.7750327 / kf },   // Tp=5.7,  Hs=1.5
        { 1.35282, 1.26148,   6.853635  / kf },   // Tp=8.5,  Hs=4.0
        { 1.81437, 1.66874,  35.134816  / kf }    // Tp=11.4, Hs=8.5
    }}
};
