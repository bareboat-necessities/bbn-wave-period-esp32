...
const std::map<WaveType, std::vector<TuningIMU>> tuning_map = {
    ...
    { WaveType::PMSTOKES, {
        ...
        { 0.316639, 0.52831,   0.0103391 / kf },   // Tp=3.0,  Hs=0.27
        { 0.599911, 0.93033,   0.1250327 / kf },   // Tp=5.7,  Hs=1.5
        { 0.900931, 0.93348,   0.27970   / kf },   // Tp=8.5,  Hs=4.0
        { 1.204587, 0.98874,   0.5312    / kf }    // Tp=11.4, Hs=8.5
    }}
};
