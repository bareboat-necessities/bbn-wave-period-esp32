...
const float FAIL_ERR_LIMIT_PERCENT = 13.0f; 
...
const std::map<WaveType, std::vector<TuningIMU>> tuning_map = {
    ...
    { WaveType::PMSTOKES, {
        ...
        { 0.90718, 0.93033,   0.2250327 / kf },   // Tp=5.7,  Hs=1.5
        { 1.35282, 1.26148,   0.40870   / kf },   // Tp=8.5,  Hs=4.0
        { 1.81437, 1.66874,   0.9712    / kf }    // Tp=11.4, Hs=8.5
    }}
};
