...
const std::map<WaveType, std::vector<TuningIMU>> tuning_map = {
    ...
    { WaveType::PMSTOKES, {
        // τ,       σ_a,     R_S  (note: values below are numerators of "… / kf")
        {0.47552, 0.56576,  0.05386 / kf},   // Wave 0  (×2.0 of JONSWAP 0.02693)
        {0.90093, 1.17877,  1.42800 / kf},   // Wave 1  (×2.5 of 0.57120)
        {1.46299, 1.60890, 12.02610 / kf},   // Wave 2  (×3.0 of 4.00870)
        {1.80901, 2.25467, 63.21360 / kf},   // Wave 3  (×3.0 of 21.07120)
        {2.18222, 2.70339, 146.92175 / kf}   // Wave 4  (×2.5 of 58.76870)
    }}
};
