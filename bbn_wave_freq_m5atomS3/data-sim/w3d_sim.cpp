...
const std::vector<WaveParameters> waveParamsList = {
    ...
    {14.3f,  14.8f, static_cast<float>(M_PI/5.0), 25.0f}
};
...
const std::map<WaveType, std::vector<TuningIMU>> tuning_map = {
    ...
    { WaveType::PMSTOKES, {
        // τ (same as JONSWAP),  σ_a (≈ +20%),     R_S (≈ 1.6–2.0× JONSWAP), still as “/ kf”
        {0.47552, 0.50519,  0.04309 / kf},   // Wave 0: 0.42099*1.2, 0.02693*1.6
        {0.90093, 0.97022,  0.97104 / kf},   // Wave 1: 0.80852*1.2, 0.57120*1.7
        {1.46299, 1.29108,  7.21566 / kf},   // Wave 2: 1.07590*1.2, 4.00870*1.8
        {1.80901, 1.62768, 38.98172 / kf},   // Wave 3: 1.35640*1.2, 21.07120*1.85
        {2.18222, 1.88394, 117.53740 / kf}   // Wave 4: 1.56995*1.2, 58.76870*2.0
    }}
};
