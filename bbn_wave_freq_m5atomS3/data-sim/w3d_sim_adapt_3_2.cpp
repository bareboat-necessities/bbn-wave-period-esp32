...
const float FAIL_ERR_LIMIT_PERCENT_Z_JONSWAP   = 35.0f;
const float FAIL_ERR_LIMIT_PERCENT_Z_PMSTOKES  = 35.0f;

const float FAIL_ERR_LIMIT_YAW_DEG = 5.5f;  

const float FAIL_ERR_LIMIT_PERCENT_3D_JONSWAP   = 60.0f;
const float FAIL_ERR_LIMIT_PERCENT_3D_PMSTOKES  = 60.0f;

const float FAIL_ACC_Z_BIAS_PERCENT             = 300.0f;
