...
const float FAIL_ERR_LIMIT_PERCENT_Z_JONSWAP   = 33.0f;
const float FAIL_ERR_LIMIT_PERCENT_Z_PMSTOKES  = 33.0f;

const float FAIL_ERR_LIMIT_YAW_DEG = 5.5f;  

const float FAIL_ERR_LIMIT_PERCENT_3D_JONSWAP   = 52.0f;
const float FAIL_ERR_LIMIT_PERCENT_3D_PMSTOKES  = 52.0f;

const float FAIL_ACC_Z_BIAS_PERCENT             = 100.0f;
...
#include "SeaStateFusionFilter2.h"
...
static void process_wave_file_for_tracker(const std::string &filename, float default_dt, bool with_mag)
{
    ...
    using Fusion = SeaStateFusion2<TrackerType::KALMANF>;
    Fusion fusion;
