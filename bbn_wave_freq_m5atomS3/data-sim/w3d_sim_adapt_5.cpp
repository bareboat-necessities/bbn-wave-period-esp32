...
class FusionAdapter5 final : public IW3dFusionAdapter {
public:
    FusionAdapter5(bool with_mag,
...
static constexpr W3dFailureLimits FAIL_LIMITS{
    ...
    .err_limit_percent_z_pmstokes = 13.0f,
    .err_limit_yaw_deg = 4.0f,
    .err_limit_percent_3d_jonswap = 55.0f,
    .err_limit_percent_3d_pmstokes = 55.0f,
    .acc_z_bias_percent = 60.0f,
    .bias_3d_percent = 400.0f,
};
...
static void process_wave_file_for_tracker(const std::string& filename, float dt, bool with_mag)
{
    ...
    auto result = process_wave_file_for_tracker<FusionAdapter5>(filename, dt, with_mag, add_noise, MAG_ODR_HZ);
    if (!result) return;
