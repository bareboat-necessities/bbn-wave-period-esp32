...
% === WaveFrequencyTracker (Adaptive PII/Mahony): Frequency / Tuner Charts ===

% PM Stokes
\begin{figure}[H]\centering
  \resizebox{\textwidth}{!}{\input{w3d_wavefreqtracker_pmstokes_low_tuner.pgf}}
  \caption{WaveFrequencyTracker-driven adaptive PII/Mahony frequency and auto-scheduling traces ($f$, accel std / $\sigma_a$, $\tau$, scheduling gain) --- PM Stokes, low $H_s$.}
  \label{fig:w3d_wavefreqtracker_pmstokes_low_tuner}
\end{figure}

\begin{figure}[H]\centering
  \resizebox{\textwidth}{!}{\input{w3d_wavefreqtracker_pmstokes_medium_tuner.pgf}}
  \caption{WaveFrequencyTracker-driven adaptive PII/Mahony frequency and auto-scheduling traces ($f$, accel std / $\sigma_a$, $\tau$, scheduling gain) --- PM Stokes, medium $H_s$.}
  \label{fig:w3d_wavefreqtracker_pmstokes_medium_tuner}
\end{figure}

\begin{figure}[H]\centering
  \resizebox{\textwidth}{!}{\input{w3d_wavefreqtracker_pmstokes_high_tuner.pgf}}
  \caption{WaveFrequencyTracker-driven adaptive PII/Mahony frequency and auto-scheduling traces ($f$, accel std / $\sigma_a$, $\tau$, scheduling gain) --- PM Stokes, high $H_s$.}
  \label{fig:w3d_wavefreqtracker_pmstokes_high_tuner}
\end{figure}

% JONSWAP
\begin{figure}[H]\centering
  \resizebox{\textwidth}{!}{\input{w3d_wavefreqtracker_jonswap_low_tuner.pgf}}
  \caption{WaveFrequencyTracker-driven adaptive PII/Mahony frequency and auto-scheduling traces ($f$, accel std / $\sigma_a$, $\tau$, scheduling gain) --- JONSWAP, low $H_s$.}
  \label{fig:w3d_wavefreqtracker_jonswap_low_tuner}
\end{figure}

\begin{figure}[H]\centering
  \resizebox{\textwidth}{!}{\input{w3d_wavefreqtracker_jonswap_medium_tuner.pgf}}
  \caption{WaveFrequencyTracker-driven adaptive PII/Mahony frequency and auto-scheduling traces ($f$, accel std / $\sigma_a$, $\tau$, scheduling gain) --- JONSWAP, medium $H_s$.}
  \label{fig:w3d_wavefreqtracker_jonswap_medium_tuner}
\end{figure}

\begin{figure}[H]\centering
  \resizebox{\textwidth}{!}{\input{w3d_wavefreqtracker_jonswap_high_tuner.pgf}}
  \caption{WaveFrequencyTracker-driven adaptive PII/Mahony frequency and auto-scheduling traces ($f$, accel std / $\sigma_a$, $\tau$, scheduling gain) --- JONSWAP, high $H_s$.}
  \label{fig:w3d_wavefreqtracker_jonswap_high_tuner}
\end{figure}


% === WaveFrequencyTracker (Adaptive PII/Mahony): Vertical Kinematics Charts ===

% PM Stokes
\begin{figure}[H]\centering
  \resizebox{\textwidth}{!}{\input{w3d_wavefreqtracker_pmstokes_low_zkin.pgf}}
  \caption{WaveFrequencyTracker-driven adaptive PII/Mahony vertical kinematics (displacement, velocity, acceleration with learned envelopes) --- PM Stokes, low $H_s$.}
  \label{fig:w3d_wavefreqtracker_pmstokes_low_zkin}
\end{figure}

\begin{figure}[H]\centering
  \resizebox{\textwidth}{!}{\input{w3d_wavefreqtracker_pmstokes_medium_zkin.pgf}}
  \caption{WaveFrequencyTracker-driven adaptive PII/Mahony vertical kinematics (displacement, velocity, acceleration with learned envelopes) --- PM Stokes, medium $H_s$.}
  \label{fig:w3d_wavefreqtracker_pmstokes_medium_zkin}
\end{figure}

\begin{figure}[H]\centering
  \resizebox{\textwidth}{!}{\input{w3d_wavefreqtracker_pmstokes_high_zkin.pgf}}
  \caption{WaveFrequencyTracker-driven adaptive PII/Mahony vertical kinematics (displacement, velocity, acceleration with learned envelopes) --- PM Stokes, high $H_s$.}
  \label{fig:w3d_wavefreqtracker_pmstokes_high_zkin}
\end{figure}

% JONSWAP
\begin{figure}[H]\centering
  \resizebox{\textwidth}{!}{\input{w3d_wavefreqtracker_jonswap_low_zkin.pgf}}
  \caption{WaveFrequencyTracker-driven adaptive PII/Mahony vertical kinematics (displacement, velocity, acceleration with learned envelopes) --- JONSWAP, low $H_s$.}
  \label{fig:w3d_wavefreqtracker_jonswap_low_zkin}
\end{figure}

\begin{figure}[H]\centering
  \resizebox{\textwidth}{!}{\input{w3d_wavefreqtracker_jonswap_medium_zkin.pgf}}
  \caption{WaveFrequencyTracker-driven adaptive PII/Mahony vertical kinematics (displacement, velocity, acceleration with learned envelopes) --- JONSWAP, medium $H_s$.}
  \label{fig:w3d_wavefreqtracker_jonswap_medium_zkin}
\end{figure}

\begin{figure}[H]\centering
  \resizebox{\textwidth}{!}{\input{w3d_wavefreqtracker_jonswap_high_zkin.pgf}}
  \caption{WaveFrequencyTracker-driven adaptive PII/Mahony vertical kinematics (displacement, velocity, acceleration with learned envelopes) --- JONSWAP, high $H_s$.}
  \label{fig:w3d_wavefreqtracker_jonswap_high_zkin}
\end{figure}
