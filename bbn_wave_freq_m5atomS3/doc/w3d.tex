...
magnetometer updates. Finally, we discuss tuning strategies and adaptive parameter estimation.
\end{abstract}

\begin{IEEEkeywords}
extended Kalman filter, inertial navigation, ocean wave kinematics, Ornstein--Uhlenbeck process, IMU, heave sensor, heave estimation,
wave height
\end{IEEEkeywords}
...
This work was prepared with the supervised assistance of artificial intelligence tools, including \textbf{ChatGPT} (OpenAI) and \textbf{DeepSeek}, which were employed to aid in code generation, mathematical drafting, and editorial preparation. All conceptual development, validation of results, and final revisions were conducted independently by the author.
