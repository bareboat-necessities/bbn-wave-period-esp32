...
where \( \Delta t \) is the time since the last zero-crossing. This approximation is physically grounded in linear wave theory, where the relationship between displacement and velocity is sinusoidal and governed by wave frequency.
