...
\begin{align}
    \bm{y}_\mathrm{z} &= \bm{z}_\mathrm{z} - \bm{H}_\mathrm{z} \bm{\hat{x}}, \\
    ...
    \bm{P}^+ &= (\bm{I} - \bm{K}_\mathrm{z} \bm{H}_\mathrm{z}) \bm{P} (\bm{I} - \bm{K}_\mathrm{z} \bm{H}_\mathrm{z})^\top + \bm{K}_\mathrm{z} \bm{R}_\mathrm{z} \bm{K}_\mathrm{z}^\top,
\end{align}
where $\bm{R}_\mathrm{z}$ is a diagonal measurement noise covariance matrix associated with the synthetic measurement.
