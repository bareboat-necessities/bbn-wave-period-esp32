...
// =======================
// DROP-IN METHODS (from Kalman3D_Wave_2)
// Paste these 5 method bodies verbatim inside your Kalman3D_Wave_3 class.
// If you previously forward-declared them in _3, remove those declarations.
// =======================
