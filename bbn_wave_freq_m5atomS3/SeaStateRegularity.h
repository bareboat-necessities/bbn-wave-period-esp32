...
struct OmegaFilter {
  ...
  float R     = 9e-1f; // measurement noise variance (rad^2/s^2)
...
class SeaStateRegularity {
  public:
    ...
    constexpr static float K_EFF_MIX  = 1.4f;     // amplitude calibration (I/Q → variance)
  ...
  private:
    ...
    float kf_R = 9e-1f;  // measurement variance
