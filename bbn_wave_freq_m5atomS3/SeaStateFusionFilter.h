...
/*
  ...
  - REMOVED: harmonic position pseudo-measurement correction.
  - REMOVED: all RS / R_S logic, bounds, knobs, tuning, setters, and Kalman3D_Wave_2 RS calls.
*/
...
// -----------------------------------------------------------------------------
// SeaStateFusion wrapper (no RS / no envelope / no harmonic corrections)
// -----------------------------------------------------------------------------
